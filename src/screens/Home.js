...
function Home ({ navigation }) {
  const [kategori, setKategori] = useState ([
    {
      nama : 'Ayam',
      navigate : 'KategoriAyam'
    },
    {
      nama : 'Mie',
      navigate : 'KategoriMie'
    },
    {
      nama : 'Sayur',
      navigate : 'KategoriSayur'
    },
    {
      nama : 'Steak',
      navigate : 'KategoriSteak'
    },
    {
      nama : 'Nasi Goreng',
      navigate : 'KategoriNasgor'
    },
    {
      nama : 'Junk Food',
      navigate : 'KategoriJF'
    ...
    {
      nama : 'Gorengan',
      navigate : 'KategoriGorengan'
    },
    {
      nama : 'Ice Cream',
      navigate : 'KategoriIce'
    },
    {
      nama : 'Salad',
      navigate : 'KategoriSalad'
    },
    {
      nama : 'Minuman',
      navigate : 'KategoriMinuman'
    },
  ]);
  ...
  const [dataTrending, setDataTrending] = useState([
    {namaResep: 'Korean Spicy Chicken', author: 'Mr. Pudidi', navigate: 'Ayam', image: require('../images/1.jpg')},
    {namaResep: 'Mie Ramen', author: 'Om Ded', navigate: 'Ramen', image: require('../images/2.jpg')},
    {namaResep: 'es Boba', author: 'Megachan', navigate: 'Boba', image: require('../images/3.jpg')},
    {namaResep: 'Eskrim Ala Mixue', author: 'Khaby Lame', navigate: 'Eskrim', image: require('../images/4.jpg')},
    {namaResep: 'Nasi Goreng Seafood', author: 'Mang Oleh', navigate: 'Nasgor', image: require('../images/5.jpg')},
  ]);
    ...
    <ScrollView>
      ...
      <View style={{
        ...
        <TouchableOpacity style={{
          ...
          flexDirection: 'row', 
          marginTop: 10
        }} onPress={() => navigation.navigate('DetailTrending')}>
          <Text style={{
            fontSize: 15, 
            color: '#bdbdbd'
          }}>
      ...
      <View style={{
        ...
        <TouchableOpacity /*onPress={() => showSnackbar()}*/ style={{
          justifyContent: 'flex-end', 
          alignItems: 'center', 
          flex: 1, 
          flexDirection: 'row', 
